...
public class ServerConnAuthActivity extends Activity {
    ...
    protected String[] getClient() {
        return new String[]{clientID, clientName};
    }
     ...
     */
    protected HashMap<String, String> getClientNamesMap() {
        return clientNamesToIDs;
    }
     ...
     */
    protected HashMap<String, String> getClientIDsMap() {
        return clientIDsToNames;
    }
